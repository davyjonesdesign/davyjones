const data = [
  ...
  // portfolio redesign
  {
    ...
    mainCap: 'Redesigned work details page with links, descriptions and images',

    // objectives
    objectives: [
      'Create a portfolio site to share with potential employers, clients, colleagues, and individuals within the professional network',
      'Invites an engaging exploration of my showcased work',
      'Foster connections and opportunities for collaboration'
    ],
    ...
    overview: [
      ...
      'I redesigned and rebuilt the it drawing inspiration from material design patterns for a clean, modern, and efficient user experience.'
    ],
    overviewImg: 'https://davyjonesdesign.github.io/data-for-axios/assets/portfolio-redesign/old-portfolio.jpg',
    overviewCap: 'Old portfolio site screenshot',

    // Method
    method: [
      'I continually sought feedback from friends and identified issues, leading to the decision to overhaul the site.',
      'I enhanced the portfolio site for improved readability, loading performance, and a more professional vibe aligned with the field.',
    ...
    // Outcome
    outcome: [
      'I launched the updated site for a more professional vibe. Further optimization and improvements has been an ongoing focus to maintain a high-quality user experience.',
      'Continued refinement has lead to the current site you see today.'
    ],
    outcomeImg: 'https://davyjonesdesign.github.io/data-for-axios/assets/portfolio-redesign/work-screenshot.jpg',
    outcomeCap: 'Redesigned portfolio work page'
  },
